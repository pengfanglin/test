...
public class RandomValueUtils {
     ...
     * @return
     */
    public static String email(int max) {
        String end = emailSuffix[(int) (Math.random() * emailSuffix.length)];
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < max - end.length(); i++) {
     ...
     * @return
     */
    public static String chineseName(int sex) {
